...
<script
	src="${pageContext.request.contextPath }/notika/js/datapicker/datepicker-active.js"></script>
<%--
											...
											<div class="modal-body">
												...
												<div class="note-shortcut-row row">
													<div
														...
														<div class="note-shortcut-row row">
															<div class="note-shortcut-col col-xs-6 note-shortcut-key">Ctrl
																+ Z</div>
															<div
								...
								<div class="note-style btn-group">
									<div class="btn-group" data-name="style">
										...
										<ul class="dropdown-menu">
											...
											<li><a data-event="formatBlock" href="#" data-value="h1"><h1>Header
														1</h1></a></li>
											<li><a data-event="formatBlock" href="#"></a>
											</li>
											</ul>
											</div>
											</div>
                     							...
                     							<button class="btn btn-default notika-btn-default" style="float:right" id="asd2">취소</button>
												<button class="btn btn-default notika-btn-default" style="float:right" id="asd1">등록</button>
											</div>
											</div>
