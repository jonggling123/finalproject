...
public interface Ljs_IAttachmentDao {
	 ...
	 * @return failed < 1
	 */
	int insertAttachmentAll(Ljs_BoardSubjectVo board);
	
	/**
	 * @param board
	 * @return not exist : list.size() == 0
	 */
	List<AttachmentVo> selectAttachmentList(Ljs_BoardSubjectVo board);
	 ...
	 * @return failed < 1
	 */
	int deleteAttachmentAll(Ljs_BoardSubjectVo board);
}
